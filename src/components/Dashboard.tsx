...
const links = [
  { name: "Timbrados", to: "/pangeaco/timbrados" },
  { name: "Networking Incident", to: "/pangeaco/ni" },
  { name: "Reasignación", to: "/pangeaco/reasignacion" },
];
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
            ...
            <div className="flex sm:justify-center space-x-6">
              <a
                href="https://www.linkedin.com/in/gersonjeanpierre/"
              ...
              >
                ...
                >
                  ...
                  <path d="M20 1C21.6569 1 23 2.34315 23 4V20C23 21.6569 21.6569 23 20 23H4C2.34315 23 1 21.6569 1 20V4C1 2.34315 2.34315 1 4 1H20ZM20 3C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3H20Z" />
                </svg>
              </a>
              <a
                href="https://github.com/gersonjeanpierre"
                className="text-gray-500 hover:text-gray-900"
                target="_blank"
              >
                <svg
